...
const WatchProviders = (props) => {
  ...
  const WatchProvider = () => {
    ApiCall(`tv/${TvShowid}/watch/providers`).then((Response) =>
  ...
  return (
    <div className="watchProviders">
      <div className="heading">
        <h2>
          Watch {tvshowData && (tvshowData.title || tvshowData.name)} Online
        </h2>
      </div>
      <div className="providers">
        ...
        (watchProviders.IN.flatrate ||
          ...
          <>
            {watchProviders &&
              ...
              (watchProviders.IN.flatrate ||
                ...
                <p>
                  You can now watch{" "}
                  {tvshowData && (tvshowData.title || tvshowData.name)} online
                  on the following streaming providers in India:
                </p>
              )}
            ...
            {watchProviders &&
              ...
              !watchProviders.IN.buy && (
                <p>
                  ...
                  {tvshowData && (tvshowData.title || tvshowData.name)} in
                  India.
                </p>
              )}
          </>
          ...
          <p>
            No watch providers available for{" "}
            {tvshowData && (tvshowData.title || tvshowData.name)} in India.
          </p>
        )}
      </div>
    </div>
